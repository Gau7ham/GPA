...
echo "
<center>
   <h1><font face='Hobo Std' color='#0052A3' size='6'>KILLFIX</font></h1>
</center>	
	
<h5><font face='Tekton Pro Ext' color='#4DB8FF' size='4'>Prevent Brute-Force Attacks and Dictionary Attacks</font></h5>



<p><font face='Times New Roman' size='3'>&nbsp;&nbsp;&nbsp;It can positively identify and proactively defend against brute force attacks and credential harvesting on account logins, password reset processes, transaction verifications and other authentication requests, collecting actionable data the business can use to halt attempts to compromise accounts in real-time.
<br>&nbsp;&nbsp;&nbsp;The data collected by ConfidentKillSwitch can also be fed into the company’s risk engine, fraud-detection platforms, or other adaptive security systems to further enhance the decisions made by those systems and help the organization proactively defend against the attacks. 
