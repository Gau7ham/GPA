...
<br>
<h5><font face="Tekton Pro Ext" color="#4DB8FF" size="6"><center>Founders of GPAS Hell Yeah!!</center></font></h5>
<br>
<!--This is the containing div position: relative to flow in sequence with the rest of the page-->
<div class="bg">
<img src="Images/back.png"  width="" height="">
</div>
<div style="position: absolute; top: 578px; left: 450px; width: 150px; height: 150px; ">
<img onmouseover="bigImg(this)" onmouseout="normalImg(this)"  border="0" src="Images/Gautham.gif"  width="102" height="102">
</div>
<div style="position: absolute; top: 561px; left: 650px; width: 150px; height: 150px;">
<img onmouseover="bigImg(this)" onmouseout="normalImg(this)" border="0" src="Images/Abhishek.gif"  width="102" height="102">
</div>

<div style="position: absolute; top: 564px; left: 890px; width: 150px; height: 150px;">
<img onmouseover="bigImg(this)" onmouseout="normalImg(this)" border="0" src="Images/Prashil.gif"  width="102" height="102">
</div>
