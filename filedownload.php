...
<li><a href='#' onClick='checkbox()'>Deactivate</a></li>
	...
	<br>	<br>
	<br>
	<h1 class="redtext">  &nbsp;&nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;&nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;      &nbsp;&nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;      &nbsp;&nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp; GPAS Software Download(1.1) (~1mb).</h1>
...
if($_POST['answer']!= "$ans" )
{
echo "<center><font color='red'>Incorrect answer. </font>
<form action='doc.php' method='post' enctype='multipart/form-data'>
<div class='form-element nextstep-button'>
<br><input type='submit' value='Go Back'class='g-button g-button-submit'>
</form></center>"; 
}
else
{
echo "
<br>
<strong><center><font size='4'> GPAS demo download </font></center></strong>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;We are currently providing only the demo copy of the project which includes a template file and demo pages of SSR shield with fake mouse pointers . <br><br>For full project please <a href='contact.php'>contact us</a> .
<br><br>

<font size='1'>
By clicking the Download button, you acknowledge that you have read and agree to the GPAS Licensing Agreement .<br><br></font>
<center><a href='final.rar'><img src='images/downloadbutton.png'></a></center>";
}
?>  
</div>
  </div>
